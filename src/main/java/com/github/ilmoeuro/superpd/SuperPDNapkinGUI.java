...
public class SuperPDNapkinGUI extends SuperPDGUI {

	private static final long serialVersionUID = -4934701250252694934L;

	
	public SuperPDNapkinGUI(VSTPluginGUIRunner r, VSTPluginAdapter plug) throws Exception {
		super(r,plug);
	...
	public static void main(String[] args) throws Throwable {
		...
		SuperPDGUI gui = new SuperPDNapkinGUI(null,null);
	}
}
