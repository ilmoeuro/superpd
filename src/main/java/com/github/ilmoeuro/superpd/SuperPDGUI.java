...
public class SuperPDGUI extends VSTPluginGUIAdapter implements ChangeListener {
	...
	public void init() {
		if (!DEBUG) {
			...
			this.volume.getSlider().setValue((int)this.pPlugin.getParameter(SuperPDProgram.PARAM_ID_VOLUME));
		    this.accent.getKnob().setValue(this.pPlugin.getParameter(SuperPDProgram.PARAM_ID_ACC_AMOUNT));
		    this.glide.getKnob().setValue(this.pPlugin.getParameter(SuperPDProgram.PARAM_ID_GLIDE_SPEED));
		    this.envmod.getKnob().setValue(this.pPlugin.getParameter(SuperPDProgram.PARAM_ID_ENV_MOD));
		    this.envdecay.getKnob().setValue(this.pPlugin.getParameter(SuperPDProgram.PARAM_ID_ENV_DECAY));
		    this.cutoff.getKnob().setValue(this.pPlugin.getParameter(SuperPDProgram.PARAM_ID_CUT_OFF));
		    this.reso.getKnob().setValue(this.pPlugin.getParameter(SuperPDProgram.PARAM_ID_RESONANCE));
	...
	public void stateChanged(ChangeEvent e) {
	    ...
	    if (!DEBUG) {
		    if (o.equals(this.volume.getSlider())) {
		      JSlider s = (JSlider)o;
		      this.pPlugin.setParameter(SuperPDProgram.PARAM_ID_VOLUME, (float)s.getValue() / 100F);
		      this.volume.getTextField().setText(this.pPlugin.getParameterDisplay(SuperPDProgram.PARAM_ID_VOLUME));
		    }
		    else if (o.equals(this.accent.getKnob())) {
		      RotaryKnob rk = (RotaryKnob)o;
		      this.pPlugin.setParameter(SuperPDProgram.PARAM_ID_ACC_AMOUNT, rk.getValue());
		      this.accent.getTextField().setText(this.pPlugin.getParameterDisplay(SuperPDProgram.PARAM_ID_ACC_AMOUNT));
		    }
		    else if (o.equals(this.glide.getKnob())) {
		      RotaryKnob rk = (RotaryKnob)o;
		      this.pPlugin.setParameter(SuperPDProgram.PARAM_ID_GLIDE_SPEED, rk.getValue());
		      this.glide.getTextField().setText(this.pPlugin.getParameterDisplay(SuperPDProgram.PARAM_ID_GLIDE_SPEED));
		 	}
		    else if (o.equals(this.envmod.getKnob())) {
		      RotaryKnob rk = (RotaryKnob)o;
		      this.pPlugin.setParameter(SuperPDProgram.PARAM_ID_ENV_MOD, rk.getValue());
		      this.envmod.getTextField().setText(this.pPlugin.getParameterDisplay(SuperPDProgram.PARAM_ID_ENV_MOD));
		    }
		    else if (o.equals(this.envdecay.getKnob())) {
		      RotaryKnob rk = (RotaryKnob)o;
		      this.pPlugin.setParameter(SuperPDProgram.PARAM_ID_ENV_DECAY, rk.getValue());
		      this.envdecay.getTextField().setText(this.pPlugin.getParameterDisplay(SuperPDProgram.PARAM_ID_ENV_DECAY));
		    }
		    else if (o.equals(this.cutoff.getKnob())) {
		      RotaryKnob rk = (RotaryKnob)o;
		      this.pPlugin.setParameter(SuperPDProgram.PARAM_ID_CUT_OFF, rk.getValue());
		      this.cutoff.getTextField().setText(this.pPlugin.getParameterDisplay(SuperPDProgram.PARAM_ID_CUT_OFF));
		    }
		    else if (o.equals(this.reso.getKnob())) {
		      RotaryKnob rk = (RotaryKnob)o;
		      this.pPlugin.setParameter(SuperPDProgram.PARAM_ID_RESONANCE, rk.getValue());
		      this.reso.getTextField().setText(this.pPlugin.getParameterDisplay(SuperPDProgram.PARAM_ID_RESONANCE));
		    }
		    else if (o.equals(this.wave)) {
		      JRadioButton r = (JRadioButton)o;
		      if (r.isEnabled()) this.pPlugin.setParameter(SuperPDProgram.PARAM_ID_WAVEFORM, 0.9F);
		    }
		    else if (o.equals(this.saw)) {
		      JRadioButton r = (JRadioButton)o;
		      if (r.isEnabled()) this.pPlugin.setParameter(SuperPDProgram.PARAM_ID_WAVEFORM, 0.1F);
		    }
	    }
	}
	...
	public static void main(String[] args) throws Throwable {
	    ...
	    SuperPDGUI gui = new SuperPDGUI(null,null);
	 ...
	 * @throws Exception 
	 */
	public SuperPDGUI(VSTPluginGUIRunner r, VSTPluginAdapter plug) throws Exception {
		super(r,plug);
		this.pPlugin=plug;
		initialize();
		this.init();
